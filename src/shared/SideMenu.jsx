...
import userImage from "/PROFESSIONAL.jpg";
const SideMenu = () => {
  return (
    <div className="">
      <div className="hidden lg:block">
        <div className="flex w-60 h-[95vh] mt-4 ml-[4%] rounded-xl flex-col justify-between border-e bg-white overflow-hidden overflow-y-auto">
          <div className="px-4 py-6">
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden mt-4 border-b">
              <summary className="flex cursor-pointer items-center justify-between rounded-lg p-2 text-gray-500 ">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-xs">
                        ...
                        <span> niloyroy184@gmail.com </span>
                      </p>
                    </div>
              ...
              <nav aria-label="Account Nav" className="mt-2 flex flex-col px-4">
                <button
                  onClick={""}
                  type="submit"
                  className="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 mb-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <button
                  onClick={""}
                  type="submit"
                  className="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 mb-4"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 opacity-75"
